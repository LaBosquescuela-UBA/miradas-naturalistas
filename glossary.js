/* =============================================================
   GLOSSARY DATA — términos del bosque andino y el páramo
   ============================================================= */
window.GLOSSARY = [
  {
    id: "aerosoles",
    term: "Aerosoles",
    cat: "Partículas atmosféricas",
    course: "01",
    def: "Son micropartículas suspendidas en el ambiente —polvo, arena, polen, sal, esporas, cenizas, microorganismos (bacterias, cianobacterias, levaduras), micrometeoritos— que actúan como núcleos de condensación. Sin ellos no hay gota, sin gota no hay lluvia."
  },
  {
    id: "agaricomycetes",
    term: "Agaricomycetes",
  ...
  },
  {
    ...
    cat: "Pigmentos",
    course: "02",
    def: "Pigmentos rojizos, violetas y azulados con valor nutricio y antioxidante. En los frutos de Vaccinium anuncian a sus dispersores; en las hojas, son filtros solares de altura."
  },
  {
    id: "apotecio",
    term: "Apotecios",
    cat: "Reproducción liquénica",
    course: "03",
    def: "Cuerpos fructíferos de algunos líquenes, pueden ser estructuras en forma de copa o disco, plana o cóncava. Dentro se forman las esporas encargadas de la reproducción sexual del simbionte hongo.Vistas al microscopio, su color y forma cuentan la historia íntima del holobionte."
  },
  {
    id: "areolas",
    term: "Areolas",
  ...
  },
  {
    id: "balitosporas",
    term: "Balitosporas",
    cat: "Esporas voladoras",
    course: "04",
    def: "Esporas catapultadas por hongos basidiomicetes que llevan en su apéndice hilar una molécula de manitol, capaz de atraer microgotas y formar nubes."
  },
  {
    id: "basidios",
    term: "Basidios",
  ...
  },
  {
    ...
    cat: "Reino fungi",
    course: "04",
    def: "Constituyen una división de hongos que incluye a aquellos que producen células llamadas basidios con basidiosporas (en láminas, poros o pliegues). Ejemplo: Amanita, Suillus, Trametes y los basidiolíquenes pertenecen a este importante grupo de hacedores de lluvia."
  },
  {
    id: "basidiosporas",
    term: "Basidiosporas",
  ...
  },
  {
    id: "bioindicador",
    term: "Bioindicador",
    cat: "Ecología sensible",
    course: "01",
    def: "Son  organismos  que  reflejan las  condiciones  ambientales  del aire, el agua o el suelo. Su presencia, ausencia o cambios en su estado fisiológico revelan alteraciones en el ambiente,  de  modo  que,  proporcionan  información  sobre  el  estado  general de un ecosistema."
  },
  {
    id: "biometeorologia",
  ...
  {
    id: "borde-de-bosque",
    term: "Borde de Bosque",
    cat: "Ecotonos",
    course: "05",
    def: "Franja entre la espesura interna del Bosque y un espacio abierto. Ejemplo: pajonal, jardín, camino. Lugar de encuentro entre especies en estados emergentes y de transición ecológica."
  },
  {
  ...
  },
  {
    ...
    cat: "Botánica",
    course: "04",
    def: "Son comunidades vegetales conformadas desde hace millones de años. Caracterizadas por ser organismos vegetales de conformación celular muy sencilla, no tienen haces vasculares, ni producen flores ni frutos, se reproducen por esporas. A estas comunidades pertenecen musgos, hepáticas y antocerotas, unas plantas pequeñas que dependen del agua para reproducirse."
  },
  {
    id: "carpoforo",
    term: "Carpóforo",
  ...
  },
  {
    ...
    cat: "Botánica",
    course: "03",
    def: "Planta sin flor que se reproduce por esporas: musgos, helechos, hepáticas, líquenes. Han sido las primeras viajeras del paisaje, capaces de habitar piedra desnuda."
  },
  {
    id: "cuticula",
    term: "Cutícula",
  ...
  },
  {
    ...
    cat: "Ecotonos",
    course: "01",
    def: "Situación que permite la interpretación de zonas de transición ecológica entre dos ecosistemas. Promueve eventos y organismos emergentes al ser estimulados por mayor radiación, viento y diversidad. Los bordes son los lugares donde la vida se experimenta a sí misma y es tan dinámica, que no puede establecerse como algo estático o definitivo."
  },
  {
  ...
  },
  {
    ...
    cat: "Biogeografía",
    course: "05",
    def: "Ser vivo al que su vida natural se restringe a un único territorio. Por ejemplo, en los Cerros Orientales sobresalen: la ranita bogotana, ericáceas verjonitas, líquenes que solo permanecen en el Bosque bogotano."
  },
  {
    id: "epifita",
    term: "Epífita",
    cat: "Estrategia de vida",
    course: "02",
    def: "Planta que crece sobre otra sin parasitarla, usando el tronco o la rama como percha para ganar luz. Ejemplo: Bromelias, orquídeas y muchos líquenes."
  },
  {
    id: "ericaceas",
    term: "Ericáceas",
    cat: "Familia botánica",
    course: "02",
    def: "Familia de plantas conformando comunidades de matorrales y árboles pequeños con una alta importancia ecológica: tienen pelos en las raíces y micorrizas de diferentes tipos para el intercambio de comunicación ecológica con el sistema micelial y la conformación del suelo. Habitan el cinturón transicional entre el bosque andino, el páramo y subpáramo."
  },
  {
    id: "erosion",
    term: "Erosión",
  ...
  {
    id: "especies-problema",
    term: "Especies problema",
    cat: "Vecinos enigma",
    course: "05",
    def: "Vecinos multiespecie que despiertan incógnitas acerca de sus maneras de aparecer en medio del Bosque. No sabemos si son habitantes o visitantes. Volver al bosque es la premisa para volverlos a encontrar."
  },
  {
    id: "esporas",
    term: "Esporas",
  ...
  {
    id: "etica-observacion",
    term: "Ética de la Observación",
    cat: "Práctica naturalista",
    course: "05",
    def: "Es cada acto de observación que cuando se hace de manera consciente, puede permitir gestos de reconocimiento y gratitud (Esquirol, 2024). Mirar sin poseer, registrar sin invadir."
  },
  {
  ...
  {
    id: "tixotropico",
    term: "Fluidos tixotrópicos",
    cat: "Néctar inteligente",
    course: "02",
    def: "Fluidos nectaríferos que se mantienen sólidos en quietud y se vuelven líquidos al ser tocados por la lengua o probóscide de algún polinizador. El néctar de muchas flores ericáceas usa esta propiedad para premiar al polinizador exacto."
  },
  {
    id: "foliaceo",
    term: "Foliáceo",
  ...
  },
  {
    ...
    cat: "Simbiosis",
    course: "03",
    def: "Somos todos los organismos conformados por la asociación íntima de muchas formas de vida —algas, hongos, bacterias, animales— que en conjunto cooperamos como una sola unidad ecológica. Los líquenes son holobiontes ejemplares; nosotros también lo somos."
  },
  {
    id: "interespecifica",
  ...
  },
  {
    ...
    cat: "Reino fungi",
    course: "04",
    def: "El conjunto de hifas que conforman la estructura de tejido vital distribuido y comunicador, capaz de extender la rizósfera para una comunicación ecológica equilibrada entre los ecosistemas. A veces forman cordones duros y resistentes subterráneos que reciben el nombre de rizomorfos."
  },
  {
    id: "micobionte",
    term: "Micobionte",
    cat: "Anatomía liquénica",
    course: "03",
    def: "Es el compañero fúngico del liquen; el bionte hongo formando parte de la simbiosis liquénica. Conforma la arquitectura interior del holobionte porque son las microfibras que traspasan las capas rizosféricas para capturar humedad y minerales, lo que trae la reserva directa de nutrientes para el fotobionte (capa algal)."
  },
  {
    id: "micorriza",
    term: "Micorrizas",
    cat: "Alianzas subterráneas",
    course: "04",
    def: "Simbiosis emergente entre raíces de plantas y hongos: las raicillas se abrazan a las hifas y se intercambian azúcares, agua y minerales. El abrazo invisible que sostiene el bosque. Mico: Hongo – Riza: Raíz"
  },
  {
    id: "microbioma",
    term: "Microbioma",
  ...
  },
  {
    ...
    cat: "Biometeorología",
    course: "01",
    def: "Es una enorme masa de nubes que recorre todo el ambiente, arrastra a su paso las micropartículas más pequeñas que replican la vida, tales como polen y esporas de diversos organismos microscópicos (ver: espora). Los mantos de niebla actúan como un amortiguador térmico porque reduce la incidencia directa de la radiación solar y mantiene la humedad. El curso de la niebla es descrito también como precipitación horizontal."
  },
  {
    id: "organismo",
    term: "Organismo",
  ...
  },
  {
    id: "paramo",
    term: "Páramo",
    cat: "Bioma altoandino",
    course: "01",
    def: "Importante lugar en la altura de las montañas para que la niebla circule y se redistribuya por la geografía, conformando extensos cuerpos de agua. Es uno de esos lugares en la alta montaña que permite el encuentro entre la memoria hídrica y los mantos de niebla, en donde habita vegetación genuina para que niebla exista, circule y se pueda distribuir por todas las formas geográficas y se puedan conformar extensos cuerpos de agua."
  },
  {
    id: "pelos-corticales",
  ...
  {
    id: "polinizacion-zumbido",
    term: "Polinización por zumbido",
    cat: "Estrategia floral",
    course: "05",
    def: "Es la técnica del abejorro Bombus, estimula a la flor rozando contra su cuerpo con zumbidos para liberar el polen."
  },
  {
    id: "poliporal",
    term: "Poliporal",
  ...
  },
  {
    ...
    cat: "Suelo vivo",
    course: "04",
    def: "Breve primer estrato enriquecido sobre los suelos gracias a las finas hebras miceliares que interconectan a la vida vegetal con la vida fúngica para el intercambio de información ecológica."
  },
  {
  ...
  },
  {
    id: "simpoiesis",
    term: "Simpoiesis",
    cat: "Filosofía relacional",
    course: "05",
    def: "Producción conjunta. Conocer-con (Haraway, 2019). Nada se hace por sí solo: vivimos y aprendemos siempre en compañía."
  },
  {
    id: "soredios",
    term: "Soredios",
    cat: "Reproducción liquénica",
    course: "03",
    def: "Células microscópicas de algas envueltas por hifas de hongos que surgen de los soralios como resultado de la reproducción asexual de líquenes. En estas formas, van a desplazarse como polvillos en el ambiente para colonizar nuevos sustratos y participar en la regeneración del bosque."
  },
  {
    id: "soralios",
    term: "Soralios",
  ...
  {
    id: "sucesion-ecologica",
    term: "Sucesión ecológica",
    cat: "Dinámica del paisaje",
    course: "05",
    def: "Es la capacidad regenerativa del Bosque en el cual hay una activa comunicación multiespecie para reconfigurar constantemente los ecosistemas. La presencia de cada conjunto de especies (pioneras, resilientes) anuncia estados emergentes vitales para la continuidad de la inteligencia natural."
  },
  {
    id: "sustrato",
    term: "Sustrato",
  ...
  },
  {
    ...
    cat: "Anatomía liquénica",
    course: "03",
    def: "Es la forma que adquiere un cuerpo liquénico. Son sistemas emergentes que generan gran variedad de estructuras vegetativas, formas de crecimiento, reproducción y biotipos especiales para las formas de vivir de un liquen. Pueden ser de tipo costroso, folioso, fruticoso, dimórfico, escamoso, gelatinoso, laminar, filamentoso."
  },
  {
    id: "taxon",
    term: "Taxón",
  ...
  },
  {
    id: "tesela",
    term: "Tesela",
    cat: "Mosaico ecológico",
    course: "03",
    def: "Pequeña pieza del mosaico que conforma un paisaje. Cada tesela —un parche de líquen, una flor, un hongo— sostiene al conjunto."
  },
  {
    id: "urceolada",
    term: "Urceolada",
...
/* mapa rápido id→entry para los popovers */
window.GLOSS_MAP = Object.fromEntries(window.GLOSSARY.map(g => [g.id, g]));
